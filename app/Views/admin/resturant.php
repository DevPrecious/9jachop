                        ...
                        <?php endif; ?>
                            ...
                            <form class="form-horizontal m-t-30" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="" name="email" value="<?= set_value('email') ?>" class="form-control"
                                        placeholder="Email">
                                </div>
                                <div class="form-group">
                                    <label>Phone number</label>
                                    <input type="number" name="number" class="form-control" value="<?= set_value('number') ?>" placeholder="Number">
                                </div>
                                <div class="form-group">
                                    <label>Open hours</label>
                                    <input type="number" value="<?= set_value('openhour') ?>" name="openhour" class="form-control" placeholder="Open hour">
                                </div>
                                <div class="form-group">
                                    <label>Close hours</label>
                                    <input type="number" name="closehour" value="<?= set_value('closehour') ?>" class="form-control" placeholder="Close hour">
                                </div>
                                <div class="form-group">
