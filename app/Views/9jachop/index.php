...
<!-- Mirrored from codenpixel.com/demo/foodpicky/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 21:27:50 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="/uploads/item/<?= esc($item['image_show']) ?>">
                                <div class="distance"><i class="fa fa-pin"></i>Hot</div>
                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">Request</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.html"><?= esc($item['name']) ?></a></h5>
                                <div class="product-name"><?= esc($item['description']) ?></div>
                                <div class="price-btn-block"> <span class="price">$ <?= esc($item['price']) ?></span> <a href="/cart/buy/<?= esc($item['id']) ?>" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.html"> <img src="/uploads/resturant/<?= esc($item['image']) ?>" width="50" height="50" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="#"><?= esc($item['resname']) ?></a> <span>Hot</span> </div>
                                </div>
                            ...
                            <div class="restaurant-wrap">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                        <a class="restaurant-logo" href="/resturant/profile/<?= esc($re['resid']) ?>"> <img src="/uploads/resturant/<?= esc($re['image']) ?>" alt="Restaurant logo"> </a>
                                    </div>
                                    <!--end:col -->
                                    <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                        <h5><a href="/resturant/profile/<?= esc($re['resid']) ?>"><?= esc($re['resname']) ?></a></h5> <span><?= esc($re['email']) ?></span>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 add-title">
                                <h4>Make an order</h4> </div>
                            <div class="col-xs-12 col-sm-5 join-text">
                                <p>Register today to get on the menu asap<a href="#"><strong> 9jachop</strong></a> </p>
                            </div>
                            <div class="col-xs-12 col-sm-4 join-btn text-xs-right"><a href="#" class="btn theme-btn btn-lg">Register</a> </div>
                        </div>
                    </div>
                </section>
                <!-- add restaurant ends -->
...
<!-- Mirrored from codenpixel.com/demo/foodpicky/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 21:28:12 GMT -->
</html>