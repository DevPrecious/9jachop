...
<!-- Mirrored from codenpixel.com/demo/foodpicky/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 21:28:50 GMT -->
<head>
    <meta charset="utf-8">
               ...
               <div class="container">
                  <div class="row">
                              ...
                              <form action="" method="post">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" name="firstname" type="text" value="<?= set_value('firstname') ?>" id="example-text-input"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Last Name</label>
                                       <input class="form-control" name="lastname" type="text" value="<?= set_value('lastname') ?>" id="example-text-input-2"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Email address</label>
                                       <input type="text" value="<?= set_value('email') ?>" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Phone number</label>
                                       <input class="form-control" type="tel" name="phone" placeholder="1-(555)-555-5555" value="<?= set_value('phone') ?>" id="example-tel-input-3"> <small class="form-text text-muted">We"ll never share your number with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" name="passconf" class="form-control" id="exampleInputPassword2" placeholder="Password"> 
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-4">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="/assets/images/Local.png" alt="" class="img-fluid">
                        <p></p>
...
<!-- Mirrored from codenpixel.com/demo/foodpicky/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 21:28:51 GMT -->
</html>